...
namespace Backend.Migrations
{
    ...
    [Migration("20241126051529_SetKeyReactFix")]
    partial class SetKeyReactFix
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Backend.Models.ReactsComment", b =>
                {
                    ...
                    b.HasKey("UserId", "CommentId")
                        .HasName("PK_reacts_comment");

                    b.HasIndex(new[] { "CommentId" }, "fk_reacts_comment_comment_id");

                    b.HasIndex(new[] { "UserId" }, "fk_reacts_comment_user_id");
